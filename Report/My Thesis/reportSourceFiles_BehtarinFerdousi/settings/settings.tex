...
\newcommand*{\getTitle}{Vehicle Localization and Tracking for Collision Avoidance Systems}
\newcommand*{\getTitleGer}{Fahrzeuglokalisierung und -verfolgung für Kollisionsvermeidungssysteme}
...
\newcommand*{\getSubmissionDate}{13.05.2020}
